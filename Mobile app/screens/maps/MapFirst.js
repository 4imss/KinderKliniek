import { View, Image, ImageBackground, Modal, Text, TouchableOpacity, ScrollView, Dimensions} from 'react-native';
    ...
    return(
        ...
        <View
            ...
            source={require('../../images/home/backgroundApp.png')}
                ...
                <Text style={globalStyles.titleSmoelenboek}>
                    1e Verdieping
                </Text>
                ...
                <View
                    style={globalStyles.lineSmoelenboek}
                />
                ...
                <Modal
                    ...
                    <View
                        ...
                        <ReactNativeZoomableView
                            ...
                            captureEvent={true}>
                            <Image
                                source={require('../../images/verdiepingen/Plattegrond1eEtageTurned.jpg')}
                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        <Image
                            source={require('../../images/verdiepingen/Plattegrond1eEtage(horizontaal).png')}
